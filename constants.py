...
CLI_MESSAGES = {
    ...
    "incorrect_task_index": f"{Fore.YELLOW}Неверное название задачи или id. Введите '--name all', чтобы посмотреть все задачи.{Style.RESET_ALL}",
    "incorrect_data": f"{Fore.YELLOW}Ошибка конвертации в json. Неверный формат данных.{Style.RESET_ALL}",
    ...
    "success_del_task": f"{Fore.BLUE}Задача успешно удалена.{Style.RESET_ALL}",
}
